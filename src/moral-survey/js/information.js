var information_template = `
  ...
  <h3 class="bolded-blue d-flex justify-content-center" data-i18n="litw-intro-h1"></h3>
  <p class="d-flex justify-content-center" data-i18n="litw-intro-p1"></p>

  <form class="needs-validation" novalidate>
    <div class="content2">
      <label class="survey1-paragraph-header form-label" for="test" data-i18n="litw-intro-l1" style="width: 400px"></label><br>
      <select class="form-select w-75" id="test" name="test" style="width: 300px" autocomplete="off" required>
    ...
    <div class="content2">
      <label class="survey1-paragraph-header form-label" for="longest_country" data-i18n="litw-intro-l2"></label><br>
      <select class="form-select w-75" id="longest_country" name="longest_country" autocomplete="off" required>
        <option value="">Choose...</option>
        ...
        <option value="Zimbabwe">Prefer not to answer</option>
      </select>
      <div class="invalid-feedback">
        You need to answer this question.
      </div>
    ...
    <div class="content2">
      <label class="survey1-paragraph-header" data-i18n="litw-intro-l3"></label><br>
      <input type="text" class="form-control w-75" aria-label="Username">
    </div>



    <div class="content2">
      <label class="survey1-paragraph-header" for="gender" data-i18n="litw-intro-l4"></label><br>
      <select class="form-select w-75" id="gender" name="gender" >
    ...
    <div class="content2">
      <label class="survey1-paragraph-header" for="lang" data-i18n="litw-intro-l5"></label><br>
      <select class="form-select w-75" id="lang" name="lang" style="width: max-content">
        ...
        <option value="Galician">Galicianvv</option>
    ...
    <div class="content2">
      <label class="survey1-paragraph-header" for="aita_user" data-i18n="litw-intro-l6"></label><br>
      <select class="form-select w-75" id="aita_user" name="aita_user" style="width: max-content">
        <option selected>Choose...</option>
        <option value="1">Yes</option>
        <option value="2">No</option>
        <option value="Not">Prefer not to answer</option>
    ...
    <div class="content2">
      <label class="survey1-paragraph-header" for="visit_aita" data-i18n="litw-intro-l7"></label><br>
      <select class="form-select w-75" id="visit_aita" name="visit_aita" style="width: max-content">
        <option value="">Choose...</option>
        <option value="1">Every day</option>
        <option value="2">Several times a week</option>
        <option value="3">Once or twice a month</option>
    ...
    <button type="submit" class="btn btn-secondary" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem; width: auto; margin-top: 20px" onclick="if(this.form.checkValidity()) { $('#btn-next-page').click(); }else {  this.form.stopPropagation(); } return false;">Next</button>
  </form>
...
module.exports = information_template;
